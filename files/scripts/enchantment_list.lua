...
enchantments = {
	...
	-- Template
	{
		...
		icon = "", -- Settings icon
		author = "evaisa", -- The author of the enchantmentvalid_spell_type
	...
	},
	{
		...
		hook = function(orig, recursion_level, iteration) -- Make sure to call orig, it calls the original action function
			c.extra_entities = c.extra_entities ..
					"mods/evaisa.enchantments/files/enchantment_data/energetic/energetic_projectiles.xml,"
	...
	},
	{
		...
		hook = function(orig, recursion_level, iteration) -- Make sure to call orig, it calls the original action function
			c.extra_entities = c.extra_entities ..
					"mods/evaisa.enchantments/files/enchantment_data/leech/leech_projectile.xml,"
	...
	},
	{
		...
		hook = function(orig, recursion_level, iteration) -- Make sure to call orig, it calls the original action function
			c.extra_entities = c.extra_entities ..
					"mods/evaisa.enchantments/files/enchantment_data/crowdcontrol/projectile.xml,"
	...
	},
	{
		...
		hook = function(orig, recursion_level, iteration) -- Make sure to call orig, it calls the original action function
			c.extra_entities = c.extra_entities ..
					"mods/evaisa.enchantments/files/enchantment_data/bane_of_arthropods/spawn.xml,"
			orig(recursion_level, iteration)
		end,
	},
	{
