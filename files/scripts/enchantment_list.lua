...
--[[ 
	-- Template
	{
		...
		valid_spell_types = {ACTION_TYPE_PROJECTILE}, -- Spell types that this enchantment can applied to
...

	{
		...
		author = "evaisa", -- The author of the enchantment
		valid_spell_types = {ACTION_TYPE_PROJECTILE, ACTION_TYPE_STATIC_PROJECTILE, ACTION_TYPE_MODIFIER, ACTION_TYPE_DRAW_MANY, ACTION_TYPE_PASSIVE}, -- Spell types that this enchantment can applied to
		is_stackable = true, -- Can the enchantment be stacked?
		card_extra_entities = {}; -- Entities added to the spell card
		weight = 1.0, -- Rarity of the enchantment
		xp = 10,
	...
	},
	{
		...
		author = "evaisa", -- The author of the enchantment
		valid_spell_types = {ACTION_TYPE_MODIFIER, ACTION_TYPE_DRAW_MANY, ACTION_TYPE_PASSIVE}, -- Spell types that this enchantment can applied to
		is_stackable = true, -- Can the enchantment be stacked?
		card_extra_entities = {}; -- Entities added to the spell card
		weight = 1.0, -- Rarity of the enchantment
		xp = 10,
	...
	},
	{
		...
		author = "evaisa", -- The author of the enchantment
		valid_spell_types = {ACTION_TYPE_PROJECTILE, ACTION_TYPE_STATIC_PROJECTILE, ACTION_TYPE_MATERIAL, ACTION_TYPE_UTILITY}, -- Spell types that this enchantment can applied to
	...
	},
	{
		...
		author = "evaisa", -- The author of the enchantment
		valid_spell_types = {ACTION_TYPE_PROJECTILE, ACTION_TYPE_STATIC_PROJECTILE, ACTION_TYPE_MODIFIER, ACTION_TYPE_DRAW_MANY, ACTION_TYPE_MATERIAL, ACTION_TYPE_PASSIVE}, -- Spell types that this enchantment can applied to
		is_stackable = true, -- Can the enchantment be stacked?
		card_extra_entities = {}; -- Entities added to the spell card
		weight = 1.0, -- Rarity of the enchantment
		xp = 10,
	...
	},
	{
		...
		author = "evaisa", -- The author of the enchantment
		valid_spell_types = {ACTION_TYPE_PROJECTILE, ACTION_TYPE_STATIC_PROJECTILE, ACTION_TYPE_MATERIAL}, -- Spell types that this enchantment can applied to
		is_stackable = false, -- Can the enchantment be stacked?
		card_extra_entities = {}; -- Entities added to the spell card
		weight = 1.0, -- Rarity of the enchantment
		xp = 10,
